...
const isLabour = (s) => (s.profile_type || "professional") === "labour";
  ...
  const side = (
    <aside className={`px-7 py-9 ${a.panel} ${a.panelText}`}>
      ...
      <div className="mt-7 space-y-5">
        ...
        <div><SideH>{isLabour(s) ? "Trade Skills" : "Skills"}</SideH><Chips items={s.key_skills} cls="bg-white/15 text-white" /></div>
...
/* Purpose-built for skilled / labour profiles: work + trade skills + availability first. */
