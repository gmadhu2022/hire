...
Creates:
  - Super Admin           admin@hire.com / admin123
  - Default institute     coco@hire.com  / inst123   (Coco Soft Institute)
...
# --- Admin ---
ensure_user("admin@hire.com", "admin123", models.ROLE_ADMIN)

# --- Default institute (for voluntary registrations) ---
inst_user, created = ensure_user("coco@hire.com", "inst123", models.ROLE_INSTITUTE)
if created:
    db.add(models.Institute(
        user_id=inst_user.id, name="Coco Soft Institute", email="coco@hire.com",
...
SAMPLE_JOBS = [
    ...
    ("Farm Labour", "agriculture", "daily", "daily", "none", "450", "600", "Nalgonda", ["Harvesting"]),
    ...
    ("Construction Labour", "daily_wage", "daily", "daily", "none", "500", "700", "Hyderabad", ["Masonry Helper"]),
]
...
db.commit()
print("Seed complete.")
print("  Admin      : admin@hire.com / admin123")
print("  Institute  : coco@hire.com  / inst123")
