...
work experience and education; a labour/skilled profile is judged on work experience,
...
def checks_for(seeker: models.JobSeeker):
    return LABOUR_CHECKS if (seeker.profile_type or "professional") == "labour" else PROFESSIONAL_CHECKS
